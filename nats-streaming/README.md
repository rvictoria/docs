...
-	[`0.9.0-linux`, `linux` (*arm64v8/Dockerfile*)](https://github.com/nats-io/nats-streaming-docker/blob/bb0111a856389f8ecabc3e1459159fc6c35e6132/arm64v8/Dockerfile)

## Shared Tags

-	`0.9.0`, `latest`:
	-	[`0.9.0-linux` (*arm64v8/Dockerfile*)](https://github.com/nats-io/nats-streaming-docker/blob/bb0111a856389f8ecabc3e1459159fc6c35e6132/arm64v8/Dockerfile)
...
```bash
$ docker run arm64v8/nats-streaming nats-streaming-server -p 4223 -m 8223
```

If you need to specify the entrypoint:

```bash
$ docker run --entrypoint c:/nats-streaming-server/nats-streaming-server arm64v8/nats-streaming
```
...
```bash
$ docker run arm64v8/nats-streaming -p 4223 -m 8223
```

If you need to specify the entrypoint:

```bash
$ docker run --entrypoint /nats-streaming-server arm64v8/nats-streaming
```
